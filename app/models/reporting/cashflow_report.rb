class CashflowReport < Report
  ...
  # cash in : invoice payment
  # cash out : bill payment, expense
  # account type : payment method (except credits)

  # ROWS:
  # => A) OPERATIONS (P&L - FIXED ASSETS)
  #   => + INCOME
  #   => - EXPENSES
  #   => - FIXED ASSETS (N'affecte pas la trésorerie)
  #   => = TOTAL

  # => B) INVESTMENTS (FIXED ASSETS purchased this PERIOD)
  #   => + ACTIFS CORPORELS
  #   => + ACTIFS INCORPORELS
  #   => + DÉPÔTS
  #   => = TOTAL
  ...
  # => VARIATION NETTE DE LA TRÉSORERIE (=A-B+C)
